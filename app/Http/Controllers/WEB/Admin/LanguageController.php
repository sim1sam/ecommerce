...
class LanguageController extends Controller
{
    ...
    public function updateAdminLanguage(Request $request){
        ...
        file_put_contents(base_path('lang/en/admin.php'), "");
        $dataArray = var_export($dataArray, true);
        file_put_contents(base_path('lang/en/admin.php'), "<?php\n return {$dataArray};\n ?>");
    ...
    public function adminValidationLanguage(){
        $data = include(base_path('lang/en/admin_validation.php'));

        return view('admin.admin_validation_language', compact('data'));
    }

    public function updateAdminValidationLanguage(Request $request){
        $dataArray = [];
        foreach($request->values as $index => $value){
            $dataArray[$index] = $value;
        }
        file_put_contents(base_path('lang/en/admin_validation.php'), "");
        $dataArray = var_export($dataArray, true);
        file_put_contents(base_path('lang/en/admin_validation.php'), "<?php\n return {$dataArray};\n ?>");
    ...
    public function updateLanguage(Request $request){
        ...
        file_put_contents(base_path('lang/en/user.php'), "");
        $dataArray = var_export($dataArray, true);
        file_put_contents(base_path('lang/en/user.php'), "<?php\n return {$dataArray};\n ?>");
    ...
    public function updateValidationLanguage(Request $request){
        ...
        file_put_contents(base_path('lang/en/user_validation.php'), "");
        $dataArray = var_export($dataArray, true);
        file_put_contents(base_path('lang/en/user_validation.php'), "<?php\n return {$dataArray};\n ?>");
