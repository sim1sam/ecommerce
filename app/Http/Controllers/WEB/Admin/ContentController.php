    ...
    public function updateImageContent(Request $request)
    {
        ...
        if ($request->empty_cart) {
            ...
            $banner_name =
                ...
                $extention;
            $banner_name = "uploads/website-images/" . $banner_name;
            Image::read($request->empty_cart)->save(
        ...
        if ($request->empty_wishlist) {
            ...
            $banner_name =
                ...
                $extention;
            $banner_name = "uploads/website-images/" . $banner_name;
            Image::read($request->empty_wishlist)->save(
                public_path() . "/" . $banner_name
            );
        ...
        if ($request->change_password_image) {
            ...
            $banner_name =
                ...
                $extention;
            $banner_name = "uploads/website-images/" . $banner_name;
            Image::read($request->change_password_image)->save(
                public_path() . "/" . $banner_name
            );
        ...
        if ($request->become_seller_avatar) {
            ...
            $banner_name =
                ...
                $extention;
            $banner_name = "uploads/website-images/" . $banner_name;
            Image::read($request->become_seller_avatar)->save(
                public_path() . "/" . $banner_name
            );
        ...
        if ($request->become_seller_banner) {
            ...
            $banner_name =
                ...
                $extention;
            $banner_name = "uploads/website-images/" . $banner_name;
            Image::read($request->become_seller_banner)->save(
                public_path() . "/" . $banner_name
            );
        ...
        if ($request->admin_login_page) {
            ...
            $banner_name =
                ...
                $extention;
            $banner_name = "uploads/website-images/" . $banner_name;
            Image::read($request->admin_login_page)->save(
                public_path() . "/" . $banner_name
            );
