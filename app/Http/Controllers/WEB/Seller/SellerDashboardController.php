...
class SellerDashboardController extends Controller
{
    ...
    public function index(){
        ...
        $todayOrders = Order::with('user')->whereHas('orderProducts',function($query) use ($seller){
        ...
        $totalOrders = Order::with('user')->whereHas('orderProducts',function($query) use ($seller){
            $query->where('seller_id', $seller->id);
        })->orderBy('id','desc')->get();
        ...
        $monthlyOrders = Order::with('user')->whereHas('orderProducts',function($query) use ($seller){
            $query->where('seller_id', $seller->id);
        ...
        $yearlyOrders = Order::with('user')->whereHas('orderProducts',function($query) use ($seller){
            $query->where('seller_id', $seller->id);
