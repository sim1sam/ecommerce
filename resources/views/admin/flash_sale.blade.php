                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.update-flash-sale') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    <label>{{__('admin.Background Color')}} <span class="text-danger">*</span></label>
                                    <input type="color" class="form-control" name="background_color" value="{{ $flash_sale->background_color ?? '#dc3545' }}">
                                </div>
                            </div>
